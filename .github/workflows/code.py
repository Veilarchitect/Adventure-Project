...
def bribe_offer(game_state: dict) -> None:
    ...
    if choice_index == 0:
        ...
        speak("You accept the money, feeling a mix of relief and crushing guilt.")
        speak(
        ...
        speak("You politely decline, saying you must follow standard procedures.")
...
def resource_allocation_dilemma(game_state: dict) -> None:
    ...
    speak("You must allocate a limited budget between two vital projects:")
...
def nepotism_pressure(game_state: dict) -> None:
    ...
    if choice_index == 0:
        speak("You refuse, emphasizing fair hiring for the good of the service.")
        speak(
...
def misuse_of_resources(game_state: dict) -> None:
    ...
    if choice_index == 0:
        ...
        speak("Seems sincere, relationship potentially preserved. Need to see.")
...
def public_statement_dilemma(game_state: dict) -> None:
    ...
    if choice_index == 0:
        ...
        speak("'Spin' might satisfy superior, confuse public, but erodes trust.")
...
def data_privacy_issue(game_state: dict) -> None:
    ...
    if choice_index == 0:
        ...
        speak("Might get fixed eventually, but lack of urgency/tracking risky.")
        ...
        speak("Ignoring such risk is negligent, could have severe consequences.")
...
def ignoring_regulations(game_state: dict) -> None:
    ...
    if choice_index == 0:
        ...
        speak("Compromise slightly speeds things but cuts corners, sets precedent.")
...
def promotion_bias(game_state: dict) -> None:
    ...
    speak("The panel chair subtly favors David, hinting Maria might not 'fit in'.")
    ...
    if choice_index == 0:
        ...
        speak("Outcome uncertain, but you fought for meritocracy against bias.")
        game_state["integrity"] += 15
